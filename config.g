...
; Drive currents
M906 X1700 Y1700 Z800 E600 I30                   ; set motor currents (mA) and motor idle factor in per cent
...
G31 K0 P500 X0 Y0 Z-1.27                         ; Set Z probe trigger value, offset and trigger height (higher Z value = nozzle closer to bed)
...
; M308 S4 Y"drivers" A"DRIVERS"                    ; Configure sensor 3 as drivers temperature

; toolhead temp
M308 S12 Y"mcu-temp" P"121.dummy" A"1LC MCU"
; M308 S13 Y"drivers" P"121.dummy" A"1LC Steppers"
