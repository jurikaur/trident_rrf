...
; usage M98 P"/sys/lib/print/print_start.g" B[first_layer_bed_temperature] E{first_layer_temperature[initial_extruder]} M[filament_type] C[Chamber maintain temp] S[heatsoak time]
; define variables

var bed_temp = param.B
var hotend_temp = param.E
var filament = param.M
...
M98 P"/sys/lib/print/heatsoak.g" T{var.bed_temp} S{var.soak_time}              ; Heatsoak bed
