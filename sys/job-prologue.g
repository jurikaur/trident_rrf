...
if {param.H} > 90
  if sensors.analog[9].lastReading < {param.C}
    M141 S{param.C} ; turn on fake chamber heater to soak cahmber
    M106 P2 S0.60
    M116 H9 ; wait chamber to reach min requested temp
  M106 P2 S0.60 ; set bed fans to 50% to heat chamber
  M106 P3 C"EXHAUSTF" S0 B0.1 H9 T60 ; set exhaust fan to trigger on max chamber temp
